...
@Service()
export class MongooseService implements OnInit {
     ...
     */
    async connect(id: string, url: string, connectionOptions: Mongoose.ConnectionOptions = {}): Promise<Mongoose.Mongoose> {
